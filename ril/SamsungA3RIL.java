 ...
 * {@hide}
 */
public class SamsungA3RIL extends RIL implements CommandsInterface {
    ...
    public SamsungA3RIL(Context context, int networkMode, int cdmaSubscription,Integer instanceId) {
